...
\begin{enumerate}
    ...
    \item To compute voxel-wise Specific Absorption Rate (SAR) distributions, enabling quantitative assessment of electromagnetic energy deposition in tumors and surrounding healthy tissue.
...
\begin{itemize}
    ...
    \item \textbf{Electromagnetic-only modeling}: Thermal feedback, blood perfusion effects, and temperature-dependent tissue properties are not modeled. The framework focuses solely on electromagnetic energy deposition (SAR computation), without coupling to thermal diffusion equations.
